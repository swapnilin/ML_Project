...
DB_CONNECTION_URL = "MONGODB_URL" #this value is set in the environemnt variable
...
"""
DATA_INGESTION_DB_NAME: str = "vehicle"
...
# Hyperparameter tuning - you can get the best parameters using grid search CV in your experimental notebook
